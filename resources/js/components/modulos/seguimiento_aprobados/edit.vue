...
export default {
    ...
    mounted() {
        this.getSeguimientoAprobado();
        this.getMaestroRegistros();
        this.loadingWindow.close();
    },
    methods: {
        getSeguimientoAprobado() {
            axios
                .get("/admin/seguimiento_aprobados/" + this.id)
                .then((response) => {
                    this.oSeguimientoAprobado = response.data;
                });
        },
        ...
        enviaRegistro() {
            this.enviando = true;
            try {
                let url = "/admin/seguimiento_aprobados/" + this.id;
                ...
                formdata.append(
                    "archivo",
                    this.oSeguimientoAprobado._archivo
                        ? this.oSeguimientoAprobado._archivo
                        : ""
                );
                formdata.append(
