...
export default {
    ...
    mounted() {
        this.getSeguimientoRectificacion();
        this.getMaestroRegistros();
        this.loadingWindow.close();
    },
    methods: {
        getSeguimientoRectificacion() {
            axios
                .get("/admin/seguimiento_rectificacions/" + this.id)
                .then((response) => {
                    this.oSeguimientoRectificacion = response.data;
                });
        },
        ...
        enviaRegistro() {
            this.enviando = true;
            try {
                let url = "/admin/seguimiento_rectificacions/" + this.id;

                let formdata = new FormData();
                formdata.append("_method", "put");
                formdata.append(
                    "maestro_registro_id",
                    this.oSeguimientoRectificacion.maestro_registro_id
                        ? this.oSeguimientoRectificacion.maestro_registro_id
                        : ""
                );
                formdata.append(
                    "responsable",
                    this.oSeguimientoRectificacion.responsable
                        ? this.oSeguimientoRectificacion.responsable
                        : ""
                );
                formdata.append(
                    "tipo_tramite",
                    this.oSeguimientoRectificacion.tipo_tramite
                        ? this.oSeguimientoRectificacion.tipo_tramite
                        : ""
                );
                formdata.append(
                    "fecha_ingreso",
                    this.oSeguimientoRectificacion.fecha_ingreso
                        ? this.oSeguimientoRectificacion.fecha_ingreso
                        : ""
                );
                formdata.append(
                    "codigo_misa",
                    this.oSeguimientoRectificacion.codigo_misa
                        ? this.oSeguimientoRectificacion.codigo_misa
                        : ""
                );
                formdata.append(
                    "hoja_ruta",
                    this.oSeguimientoRectificacion.hoja_ruta
                        ? this.oSeguimientoRectificacion.hoja_ruta
                        : ""
                );
                formdata.append(
                    "motivo_rectificacion",
                    this.oSeguimientoRectificacion.motivo_rectificacion
                        ? this.oSeguimientoRectificacion.motivo_rectificacion
                        : ""
                );
                formdata.append(
                    "agemed_estado",
                    this.oSeguimientoRectificacion.agemed_estado
                        ? this.oSeguimientoRectificacion.agemed_estado
                        : ""
                );
                formdata.append(
                    "agemed_observacion",
                    this.oSeguimientoRectificacion.agemed_observacion
                        ? this.oSeguimientoRectificacion.agemed_observacion
                        : ""
                );
                formdata.append(
                    "agemed_fecha",
                    this.oSeguimientoRectificacion.agemed_fecha
                        ? this.oSeguimientoRectificacion.agemed_fecha
                        : ""
                );
                formdata.append(
                    "megalabs_estado",
                    this.oSeguimientoRectificacion.megalabs_estado
                        ? this.oSeguimientoRectificacion.megalabs_estado
                        : ""
                );
                formdata.append(
                    "megalabs_fecha",
                    this.oSeguimientoRectificacion.megalabs_fecha
                        ? this.oSeguimientoRectificacion.megalabs_fecha
                        : ""
                );
                formdata.append(
                    "rs_fecha",
                    this.oSeguimientoRectificacion.rs_fecha
                        ? this.oSeguimientoRectificacion.rs_fecha
                        : ""
                );
                formdata.append(
                    "rs_nro_registro",
                    this.oSeguimientoRectificacion.rs_nro_registro
                        ? this.oSeguimientoRectificacion.rs_nro_registro
                        : ""
                );
                formdata.append(
                    "rs_fecha_recojo",
                    this.oSeguimientoRectificacion.rs_fecha_recojo
                        ? this.oSeguimientoRectificacion.rs_fecha_recojo
                        : ""
                );
