...
export default {
    ...
    methods: {
        ...
        getSeguimientoTramites() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    this.listRegistros = res.data.seguimiento_tramites;
        ...
        eliminaSeguimientoTramite(id, descripcion) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post("/admin/seguimiento_tramites/" + id, {
                            _method: "DELETE",
                        })
                        .then((res) => {
                            this.getSeguimientoTramites();
        ...
        aprobarSeguimientoTramite(id, descripcion) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post("/admin/seguimiento_tramites/aprobar/" + id)
                        .then((res) => {
                            this.getSeguimientoTramites();
                            this.filter = "";
                            Swal.fire({
        ...
        anularSeguimientoTramite(id, descripcion) {
            Swal.fire({
        ...
        pdf(id) {
            ...
            axios
                .post("/admin/seguimiento_tramites/pdf/" + id, null, config)
                .then((res) => {
                    this.errors = [];
                    this.enviando = false;
