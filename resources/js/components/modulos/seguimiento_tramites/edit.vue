    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Seguimiento de Trámites - <small>Editar</small></h1>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods: {
        ...
        enviaRegistro() {
            this.enviando = true;
            try {
                let url = "/admin/seguimiento_tramites/" + this.id;
                ...
                formdata.append(
                    "cpp_archivo",
                    this.oSeguimientoTramite._cpp_archivo
                        ? this.oSeguimientoTramite._cpp_archivo
                        : ""
                );
                formdata.append(
                ...
                formdata.append(
                    "muestra_archivo",
                    this.oSeguimientoTramite._muestra_archivo
                        ? this.oSeguimientoTramite._muestra_archivo
                        : ""
                );
                formdata.append(
                ...
                formdata.append(
                    "desplegado_archivo",
                    this.oSeguimientoTramite._desplegado_archivo
                        ? this.oSeguimientoTramite._desplegado_archivo
                        : ""
                );
                formdata.append(
                ...
                formdata.append(
                    "gmp_archivo",
                    this.oSeguimientoTramite._gmp_archivo
                        ? this.oSeguimientoTramite._gmp_archivo
                        : ""
                );
                formdata.append(
                ...
                formdata.append(
                    "rl_archivo",
                    this.oSeguimientoTramite._rl_archivo
                        ? this.oSeguimientoTramite._rl_archivo
                        : ""
                );
