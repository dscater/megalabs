...
export default {
    ...
    methods: {
        getNota() {
            axios.get("/admin/notas/" + this.id).then((response) => {
                this.oNota = response.data;
            });
        },
        ...
        enviaRegistro() {
            this.enviando = true;
            try {
                let url = "/admin/notas/" + this.id;

                let formdata = new FormData();
                formdata.append("_method", "put");
                formdata.append(
                    "maestro_registro_id",
                    this.oNota.maestro_registro_id
                        ? this.oNota.maestro_registro_id
                        : ""
                );
                formdata.append(
                    "referencia",
                    this.oNota.referencia ? this.oNota.referencia : ""
                );
                formdata.append(
                    "descripcion",
                    this.oNota.descripcion ? this.oNota.descripcion : ""
                );
                formdata.append(
                    "archivo",
                    this.oNota._archivo ? this.oNota._archivo : ""
                );
                formdata.append(
                    "fecha",
                    this.oNota.fecha ? this.oNota.fecha : ""
                );
