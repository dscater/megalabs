                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <el-select
                                            ...
                                            v-model="oNotificacion.maestro_registro_id"
                                        >
                                            <el-option
...
export default {
    ...
    methods: {
        ...
        enviaRegistro() {
            this.enviando = true;
            try {
                let url = "/admin/notificacions";

                let formdata = new FormData();
                formdata.append("maestro_registro_id",this.oNotificacion.maestro_registro_id? this.oNotificacion.maestro_registro_id: "");
                formdata.append("referencia",this.oNotificacion.referencia? this.oNotificacion.referencia: "");
                formdata.append("descripcion",this.oNotificacion.descripcion? this.oNotificacion.descripcion: "");
                formdata.append("archivo",this.oNotificacion.archivo? this.oNotificacion.archivo: "");
                formdata.append("fecha",this.oNotificacion.fecha? this.oNotificacion.fecha: "");
