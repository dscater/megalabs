...
export default {
    ...
    methods: {
        ...
        getNotificacions() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    this.listRegistros = res.data.notificacions;
        ...
        eliminaNotificacion(id, descripcion) {
            Swal.fire({
        ...
        aprobarNotificacion(id, descripcion) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post("/admin/notificacions/aprobar/" + id)
                        .then((res) => {
                            this.getNotificacions();
                            this.filter = "";
                            Swal.fire({
        ...
        anularNotificacion(id, descripcion) {
            Swal.fire({
        ...
        pdf(id) {
            ...
            axios
                .post("/admin/notificacions/pdf/" + id, null, config)
                .then((res) => {
                    this.errors = [];
                    this.enviando = false;
        ...
        descargarArchivo(id) {
            ...
            axios
                .post("/admin/notificacions/archivo/" + id, null, config)
                .then((res) => {
                    console.log(res);
